...
WebUI.verifyElementPresent(findTestObject('PageObjects/Page_playprosite/combo_name2'), 15)

WebUI.click(findTestObject('PageObjects/Page_playprosite/combo_name2'))

WebUI.delay(15)

def ActualComboURL = WebUI.getUrl()

WebUI.verifyEqual(ActualComboURL, 'https://demotenant.playpro.fr/discover/combos/chcombodemo?id=97')
