...
WebUI.setText(findTestObject('FO_Register/Page_/input__email'), 'chemail2@gmail.com')

WebUI.setText(findTestObject('FO_Register/Page_/input_Phone_form-control'), '23400811')
...
WebUI.verifyElementText(findTestObject('FO_Register/Page_/div_Telephone_Numero_Already_Exists'), 'La valeur du champ téléphone est déjà utilisée.')
