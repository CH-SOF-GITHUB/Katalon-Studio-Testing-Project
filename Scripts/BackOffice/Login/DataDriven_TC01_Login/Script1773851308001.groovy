...
// set email
WebUI.setText(findTestObject('BackOffice/input_Connectez-vous_email'), email)

// set password
WebUI.setEncryptedText(findTestObject('BackOffice/input_Connectez-vous_password'), password)
